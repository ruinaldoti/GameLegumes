...
buttons[1] = display.newImage("Imagens/button1.png") --up
buttons[1].x = 250
buttons[1].y = 380
buttons[1].myName = "up"
buttons[1].rotation = -90

buttons[2] = display.newImage("Imagens/button1.png") -- down
buttons[2].x = 250
buttons[2].y = 440
buttons[2].myName = "down"
buttons[2].rotation = 90

buttons[3] = display.newImage("Imagens/button1.png") -- left
buttons[3].x = 210
buttons[3].y = 410
buttons[3].myName = "left"
buttons[3].rotation = 180

buttons[4] = display.newImage("Imagens/button1.png") -- right
buttons[4].x = 290
buttons[4].y = 410
...
timer.performWithDelay( 2000, criarLegumes, -1 )
